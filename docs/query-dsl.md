...
Meadow uses [FoxHound](https://fable-retold.github.io/foxhound/) as its query DSL. FoxHound provides a fluent, chainable API for building database queries without writing raw SQL. Meadow wraps FoxHound and manages query lifecycle, cloning, and schema injection.
