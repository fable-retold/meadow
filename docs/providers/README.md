...
|----------|----------|-------------------|
| [MySQL](mysql.md) | Production web applications, MySQL/MariaDB | [meadow-connection-mysql](https://fable-retold.github.io/meadow-connection-mysql/) |
| [MSSQL](mssql.md) | Enterprise environments, SQL Server | [meadow-connection-mssql](https://fable-retold.github.io/meadow-connection-mssql/) |
| [SQLite](sqlite.md) | Embedded applications, local development | [meadow-connection-sqlite](https://fable-retold.github.io/meadow-connection-sqlite/) |
...
- [Meadow-Endpoints](https://fable-retold.github.io/meadow-endpoints/) -- REST API generation on top of Meadow providers
