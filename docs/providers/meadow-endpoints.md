...
This mapping follows the standard Meadow REST conventions generated by [meadow-endpoints](https://fable-retold.github.io/meadow-endpoints/) on the server side.
...
This pattern is especially powerful when combined with [meadow-endpoints](https://fable-retold.github.io/meadow-endpoints/) on the server, which auto-generates REST routes from Meadow entity definitions.
...
- [meadow-endpoints](https://fable-retold.github.io/meadow-endpoints/) -- Server-side REST API generation
